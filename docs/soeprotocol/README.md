...
## Context
This section on SOE protocol was taken from [Sanctuary.SoeProtocol](https://github.com/PS2Sanctuary/Sanctuary.SoeProtocol) 

## Abstract

The SOE protocol is a UDP transport layer for the networking traffic of many games developed by
Sony Online Entertainment, i.e. H1Z1:KOTK
...
See `src/soe/coreProtocol.h` to see definitions for OP codes. 
